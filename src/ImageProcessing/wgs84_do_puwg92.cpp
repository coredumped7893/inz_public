...
/**
 * @brief Converts wgs84 coordinate system to the puwg92
 * @param B_stopnie
 * @param L_stopnie
 * @param Xpuwg
 * @param Ypuwg
...
*/
    ...
    double L0_stopnie=19.0; 		//Początek uk�adu wsp. PUWG92 (długość)
    double m0=0.9993;
    double x0=-5300000.0;
    double y0= 500000.0;
...
/**
 * @brief Converts puwg92 coordinate system to the wgs84
 * @param Xpuwg
 * @param Ypuwg
 * @param B_stopnie
 * @param L_stopnie
